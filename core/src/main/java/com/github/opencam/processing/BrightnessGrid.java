...
public class BrightnessGrid implements ImageDiff<List<Double>>, Configurable {
  int xwidth;
  int ywidth;
  int step;

  public BrightnessGrid() {
    super();
  }

  public BrightnessGrid(final int xwidth, final int ywidth, final int step) {
    super();
    this.xwidth = xwidth;
    this.ywidth = ywidth;
    this.step = step;
  ...
  public List<Double> getImageMeta(final BufferedImage img) {
    ...
    final int halfSize = xboxes * yboxes;
    final double[] grid = new double[xboxes * yboxes * 2];
  ...
  public int getImageDiff(final List<Double> img1, final List<Double> img2, final BufferedImage img, final int thresh) {
    ...
    final int halfLength = img1.size() / 2;
  ...
  public String toString() {
    return "BrightnessGrid [xwidth=" + xwidth + ", ywidth=" + ywidth + ", step=" + step + "]";
  }
